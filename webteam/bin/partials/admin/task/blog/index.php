<?php
	...
	if(isset($_POST['for_insert'])){
		...
		header("location: ?admin_page=blog");
	}
...
<body>
	...
	<article>
		<form action="" method="POST">
			...
			<input type="hidden" placeholder="Typing data here ..." name="insr_id_link" class="id_link_render">
			<div class="form-inli col-lg-6">
		...
		<?php while($row_blog_id = $sql_blog_id_rs->fetch_assoc()):?>
			...
			<article>
				<form action="" method="POST">
					...
					<div class="form-inli col-lg-12">
						<label for="">Content</label>
						<textarea class="froala-editor-update" name="content_id"><?php echo $row_blog_id['content'];?></textarea>
